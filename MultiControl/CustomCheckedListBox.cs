        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (e.Index != -1)
            {
                if ((e.State & DrawItemState.Selected) == DrawItemState.Selected)
                {
                    ...
                    e.Graphics.DrawString(Items[e.Index].ToString(), this.Font, Brushes.White, e.Bounds.Left + 26, e.Bounds.Top);
                }
                else
                {
                    e.Graphics.FillRectangle(Brushes.White, e.Bounds);
                    e.Graphics.DrawString(Items[e.Index].ToString(), this.Font, Brushes.Black, e.Bounds.Left + 26, e.Bounds.Top);
                }
                ...
                {
                    e.Graphics.FillRectangle(Brushes.Red, box);
                }
                else
                {
