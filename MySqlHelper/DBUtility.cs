...
namespace PLA.DBUtility
{
    ...
    public abstract class MYSQLHelper
    {
        ...
        public static string connectionStringManager = "";
        //public static readonly string connectionStringManager = ConfigurationManager.ConnectionStrings["conn_str"].ConnectionString;
        ...
        /// <returns></returns>
        public async static Task<string> CheckConnection(string conn_str)
        {
            connectionStringManager = conn_str;
            try
            {
        ...
        public static bool ExecuteTransaction(string connectionString, CommandType cmdType, string[] cmdTexts, params MySqlParameter[][] commandParameters)
        {
            ...
            MySqlTransaction myTrans = myConnection.BeginTransaction();                 //begin a transaction
            MySqlCommand cmd = new MySqlCommand();
